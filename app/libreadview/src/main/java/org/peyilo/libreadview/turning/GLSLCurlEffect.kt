...
import org.peyilo.libreadview.turning.render.GlslPageRenderer
...
class GLSLCurlEffect: FlipOnReleaseEffect.Horizontal(), AnimatedEffect {
    ...
    companion object {
        private const val TAG = "GLSLCurlEffect"
    }
}